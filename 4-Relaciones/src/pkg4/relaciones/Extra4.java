...
import Entity.Voto;
import Service.SimuladorEggService;
...
public class Extra4 {
    ...
    public static void main(String[] args) {
        SimuladorEggService se = new SimuladorEggService();
        
        ArrayList<Voto> votos = new ArrayList();
        ArrayList<Alumno> alumnos = new ArrayList();
        
        se.votacion(alumnos,votos);
        se.mostrarListaVotos(votos);
        se.facilitadores(votos);
